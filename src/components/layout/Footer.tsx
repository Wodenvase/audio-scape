    ...
    <footer className="w-full bg-music-darker py-12 px-4 mt-20">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h4 className="text-white font-medium mb-4">Team Ambitians</h4>
            <ul className="space-y-2 text-sm">
              <li className="text-gray-400"><span className="text-primary font-medium">Team Lead:</span> Dipanta Bhattacharyya</li>
              <li className="text-gray-400">Ritvik Kumar</li>
              <li className="text-gray-400">Navneet Agrawal</li>
              <li className="text-gray-400">Vinayak Dev Mishra</li>
              <li className="text-gray-400">Sahil Saxena</li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-xs text-gray-500">
          <p>&copy; {new Date().getFullYear()} AudioScape. Built by Team Ambitians. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
